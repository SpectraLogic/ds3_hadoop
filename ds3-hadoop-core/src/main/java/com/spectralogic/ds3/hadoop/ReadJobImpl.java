...
class ReadJobImpl implements Job {
    ...
    ReadJobImpl(final Ds3Client ds3Client, final FileSystem hdfs, final MasterObjectList masterObjectList, final Configuration configuration, final JobOptions options) {
...
@Override
    public PutJobIterator iterator() throws IOException {
        return new PutJobIterator(jobConfFactory, this.ds3Client, this.conf, this.hdfs, this.options, this.bucketName, this.masterObjectList, BulkGet.class);
    }
